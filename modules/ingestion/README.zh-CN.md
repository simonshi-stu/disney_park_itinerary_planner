...
## 当前状态与缺口
Bootstrap 位于 `scripts/collect-wait-times.mjs`、`scripts/update-cache.mjs` 和 GitHub workflow，迁移前保持行为稳定。当前仍写 CSV/JSON 到 Git，尚无永久 raw archive 或 source-health persistence。
